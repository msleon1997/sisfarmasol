...
include "controller/ModuleDoc.php";
include "controller/ModuleRep.php";
...
include "controller/SessionDoc.php";
include "controller/Lb.php";
include "controller/LbDoc.php";
include "controller/LbRep.php";

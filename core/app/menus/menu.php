              ...
              <ul class="nav">
                  ...
                  <li>
                      <a href="./?view=reservaciones">
                          ...
                          <p style="color: whitesmoke;  ">Citas</p>
                      </a>
                  </li>
                  ...
                  <li>
                      <a href="./?view=medicos">
                          ...
                          <p style="color: whitesmoke;  ">Medicos</p>
                      </a>
                  </li>
                  <li>
                      <a href="./?view=categorias">
                          <i class="fa fa-th-list"></i>
                          <p style="color: whitesmoke;  ">Categorias</p>
                      </a>
                  </li>
                  <li>
                      <a href="./?view=reports">
                          <i class="fa fa-area-chart"></i>
                          <p style="color: whitesmoke;  ">Emitir Factura </p>
                      </a>
                  </li>
                  <li>

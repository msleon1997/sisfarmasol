...
class ReservationData {
	...
	public function getMedic(){ return MedicData::getById($this->medic_id); }
        public function getCategory(){ return CategoryData::getById($this->category); }
	public function getStatus(){ return StatusData::getById($this->status_id); }


	public function add(){
		$sql = "insert into reservation (title,medic_id,category,date_at,time_at,pacient_id,user_id,status_id,created_at) ";
		$sql .= "value (\"$this->title\",\"$this->medic_id\",\"$this->category\",\"$this->date_at\",\"$this->time_at\",\"$this->pacient_id\",\"$this->user_id\",\"$this->status_id\",$this->created_at)";
...
// partiendo de que ya tenemos creado un objecto ReservationData previamente utilizamos el contexto
	public function update(){
		$sql = "update ".self::$tablename." set title=\"$this->title\",pacient_id=\"$this->pacient_id\",medic_id=\"$this->medic_id\",category=\"$this->category\",date_at=\"$this->date_at\",time_at=\"$this->time_at\",status_id=\"$this->status_id\" where id=$this->id";
		Executor::doit($sql);
	}

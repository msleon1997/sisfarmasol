...
<div class="card">
  ...
  <div class="card-content table-responsive">
		...
		<form class="form-horizontal" method="post" id="addproduct" action="index.php?view=añadirficha" role="form">
  <div class="card">
...
-- SELECCIONE --
   ...
   <option>Masculino</option>
    ...
    <div class="col-lg-2">
        <input type="text" name="est_civil" class="form-control" id="est_civil" >
    </div>
      </div>
  </div>    
 <br><br> <br> 
 <div class="card">
  <div class="form-group">
     ...
     <div class="col-lg-8">
         ...
         <input type="text" name="mot_consult" class="form-control" id="mot_consult" placeholder="escriba aqui el motivo">
...
<div class="card">
  <div class="form-group">
    ...
    <label for="inputEmail1" class="col-lg-2 control-label"></label>
    <div class="col-lg-8">
        <textarea  name="antecedents" class="form-control" id="antecedents" ></textarea>
    </div>
  </div>
</div>
<div class="card">
  <div class="form-group">
    ...
    <div class="col-lg-2">
        <input type="number" name="fathers" class="form-control" id="fathers" placeholder="Nº padres">
    </div>
    <label for="inputEmail1" class="col-lg-2 control-label"><h5>Vivos</h5></label>
    <div class="col-lg-1">
        <input type="number" name="liveP" class="form-control" id="liveP">
    </div>
    ...
    <div class="col-lg-2">
        <input type="number" name="brothers" class="form-control" id="brothers" placeholder="Nº hermanos" >
    </div>
    
    <label for="inputEmail1" class="col-lg-2 control-label"><h5>Vivos</h5></label>
    <div class="col-lg-1">
        <input type="number" name="liveH" class="form-control" id="liveH">
    </div>
    ...
    <label for="inputEmail1" class="col-lg-2 control-label"><h5>Vivos</h5></label>
    <div class="col-lg-1">
        <input type="number" name="liveS" class="form-control" id="lives" >
    </div>
  </div>
  </div>
     <div class="form-group">
    ...
    <div class="col-lg-1">
        <input type="radio" name="dbt" class="form-control" id="yes" value="si">
    </div>
    <label for="inputEmail1" class="col-lg-2 control-label"><h5>No</h5></label>
    <div class="col-lg-1">
        <input type="radio" name="dbt" class="form-control" id="no" value="no">
    </div>
    ...
    <label for="inputEmail1" class="col-lg-2 control-label"><h5>Si</h5></label>
    <div class="col-lg-1">
        <input type="radio" name="hta" class="form-control" id="yes" value="si" >
    
    </div>
    
    <label for="inputEmail1" class="col-lg-2 control-label"><h5>No</h5></label>
    <div class="col-lg-1">
        <input type="radio" name="hta" class="form-control" id="no" value="no">
    </div>
    ...
    <label for="inputEmail1" class="col-lg-2 control-label"><h5>Si</h5></label>
    <div class="col-lg-1">
        <input type="radio" name="tbc" class="form-control" id="yes" value="si">
    </div>
    <label for="inputEmail1" class="col-lg-2 control-label"><h5>No</h5></label>
    <div class="col-lg-1">
        <input type="radio" name="tbc" class="form-control" id="no" value="no">
    </div>
  </div>
         <div class="form-group">
    ...
    <label for="inputEmail1" class="col-lg-2 control-label"><h5>Si</h5></label>
    <div class="col-lg-1">
        <input type="radio" name="gamelar" class="form-control" id="yes" value="si">
        
    </div>
    <label for="inputEmail1" class="col-lg-2 control-label"><h5>No</h5></label>
    <div class="col-lg-1">
        <input type="radio" name="gamelar" class="form-control" id="no" value="no">
    </div>
  </div>
   <div class="form-group">

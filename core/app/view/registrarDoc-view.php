...
<div class="card">
  ...
  <div class="card-content table-responsive">
			    	<form accept-charset="UTF-8" role="form" method="post" action="index.php?view=regproDoc">
                                <fieldset>
			    	  	<div class="form-group">
                                           
                                               
                                             
                                                <input class="form-control"  class="fa fa-calendar" placeholder="Nombre Doctor" name="name" type="text" required>
			    		</div>
                                        <div class="form-group">
                                           
                                               
                                             
                                                <input class="form-control"  class="fa fa-calendar" placeholder="Apellido Doctor" name="lastname" type="text" required>

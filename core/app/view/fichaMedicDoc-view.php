...
<div class="card">
  <div class="card-header" data-background-color="blue">
    ...
    <div class="card-content table-responsive">
        <a href="indexDoc.php?view=nuevafichaMedicDoc" class="btn btn-default"><i class='fa fa-male'></i> Nueva Ficha Medica</a>
    <form class="form-horizontal" role="form">
<input type="hidden" name="view" value="fichaMedicDoc">
        <?php
...
<!--                                <td><?php // echo $user->dni; ?></td>    -->
				...
				<td style="width:280px;">
                                <center><a href="indexDoc.php?view=historialCliDoc&id=<?php echo $user->id;?>" class="btn btn-default btn-xs">Historial</a>
				<a href="indexDoc.php?view=editfichaMedicDoc&id=<?php echo $user->id;?>" class="btn btn-warning btn-xs">Editar</a>
                                <a href="indexDoc.php?view=delfichaMedicDoc&id=<?php echo $user->id;?>" class="btn btn-danger btn-xs">Eliminar</a></center>
                                <center><a href="indexReport.php?view=reportficha&id=<?php echo $user->id;?>" class="btn btn-xs" style="background-color: #0000ff;"><i class="fa fa-file-word-o" aria-hidden="true"></i> Descargar</a>
                                    <a href="indexReport.php?view=reportfichaxls&id=<?php echo $user->id;?>" class="btn btn-xs" style="background-color: #008000;"><i class="fa fa-file-excel-o" aria-hidden="true"></i> Descargar</a></center>
				</td>
				</tr>
				<?php

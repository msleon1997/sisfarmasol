...
<head>
    ...
    <!-- Bootstrap CSS -->
    <link href="assets/odontograma/css/base.css" rel="stylesheet">
    <link href="assets/odontograma/tools/bootstrap/css/bootstrap.css" rel="stylesheet">
...
<body>
            ...
            <div class="panel-body">
               <center><div class="row">
                    <div class="col-md-6 col-md-offset-3">
                        <div id="controls" class="panel panel-default" style="    width: 639px;text-align: center; margin-left: -82px;">
                            ...
                            <div class="panel-body">
                                <div class="btn-group" data-toggle="buttons">
                                    ...
                                    <label id="extraer" class="btn btn-success">
                    ...
                    <div id="tr" class="col-xs-6 col-sm-6 col-md-6 col-lg-6" style="margin-left: -9%; border-left: none; border-bottom: none; border-right:none;">
                    </div>
                    <div id="tl" class="col-xs-6 col-sm-6 col-md-6 col-lg-6" style="border-left: none; border-bottom: none; border-right:none;">
                    </div>
                    <div id="tlr" class="col-xs-6 col-sm-6 col-md-6 col-lg-6 text-right" style="margin-left: -9%; border-left: none; border-bottom: none; border-right:none;">
                    </div>
                    <div id="tll" class="col-xs-6 col-sm-6 col-md-6 col-lg-6" style="border-left: none; border-bottom: none; border-right:none;">
                    </div>
                </div>
                </center>
                <div class="row">
                    <div id="blr" class="col-xs-6 col-sm-6 col-md-6 col-lg-6 text-right" style="margin-left: -8%; border-left: none; border-bottom:none; border-right:none;">
                    </div>
                    <div id="bll" class="col-xs-6 col-sm-6 col-md-6 col-lg-6" style="margin-left: 8%; border-left: none; border-bottom:none; border-right:none;">
                    </div>
                    <div id="br" class="col-xs-6 col-sm-6 col-md-6 col-lg-6" style="margin-left: -3%; border-left: none; border-bottom:none; border-right:none;">
                    </div>
                    <div id="bl" class="col-xs-6 col-sm-6 col-md-6 col-lg-6" style="border-left: none;border-bottom:none; border-right:none;">
                    </div>
                </div>
                <div class="row">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-body">
                                ...
                                <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 text-right">
                                    <span style="display:inline:block;"> Pieza Extraída</span> = <img style="display:inline:block;" src="assets/odontograma/images/extraccion.png">
    ...
    <!-- jQuery -->
    <script src="assets/odontograma/jquery-1.10.2.min.js"></script>
    <!-- Bootstrap JavaScript -->
    <script src="assets/odontograma/tools/bootstrap/bootstrap.js"></script>
    ...
    function createOdontogram() {
        ...
        for (var i = 9 - 1; i >= 1; i--) {
            ...
            htmlRight += 
                '<div data-name="value" id="dienteindex' + i + '" class="diente">' +
    ...
    $(document).ready(function() {
     ...
     <center><input type="button" value="Agregar e Imprimir" id="agregar" class="btn btn-success" onclick="javascript:window.print()"/></center>
</body>
